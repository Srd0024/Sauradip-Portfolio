...
import { HELMI_EXPERIENCES, HELMI_EDUCATION, HELMI_COURSES } from '../data/portfolioData';
        ...
        <div className="flex flex-col gap-8 h-full">
          ...
          <div className="bg-white rounded-[32px] p-6 sm:p-8 border border-neutral-300 shadow-2xs">
            ...
            <div className="space-y-7">
              {/* Item 1: IILM Institute */}
              <div className="flex items-start gap-3.5 sm:gap-4">
                <div className="shrink-0 mt-0.5">
                  <CompanyLogo type={HELMI_EDUCATION[0].logoType} className="w-10 h-10 sm:w-11 sm:h-11" />
                </div>
                <div className="flex-1">
              ...
              {/* Item 2: KC Das Commerce College */}
              <div className="flex items-start gap-3.5 sm:gap-4">
                <div className="shrink-0 mt-0.5">
                  <CompanyLogo type={HELMI_EDUCATION[1].logoType} className="w-10 h-10 sm:w-11 sm:h-11" />
                </div>
                <div className="flex-1">
                  <h3 className="font-heading font-extrabold text-sm sm:text-base text-[#111111] leading-snug">
          ...
          {/* Courses Box & CTA */}
          <div className="bg-white rounded-[32px] p-6 sm:p-8 border border-neutral-300 shadow-2xs flex flex-col justify-between flex-1">
            <div>
              {/* Heading: courses. */}
              <h2 className="font-heading font-black text-4xl sm:text-5xl text-[#111111] tracking-tight lowercase mb-8">
                courses.
              ...
              <div className="space-y-7 mb-10">
                {HELMI_COURSES.map((course) => (
                  <div key={course.id} className="flex items-start gap-3.5 sm:gap-4">
                    {course.logoType && (
                      <div className="shrink-0 mt-0.5">
                        <CompanyLogo type={course.logoType} className="w-10 h-10 sm:w-11 sm:h-11" />
                      </div>
                    )}
                    <div className="flex-1">
                      <h3 className="font-heading font-extrabold text-sm sm:text-base text-[#111111] leading-snug">
                        {course.degreeOrProgram}
                      </h3>
                      <p className="text-[11px] font-mono text-neutral-400 mt-0.5 mb-1 font-medium">
            ...
            <div className="pt-4 border-t border-neutral-100 relative mt-auto">
